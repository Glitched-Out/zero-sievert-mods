...
if instance_exists(obj_player)
{
    ...
    if (obj_player.state == gml_Script_scr_player_state_inventory)
    {
        ...
        draw_rectangle_color(276, 249, 303, 257, c_white, c_white, c_white, c_white, 0)
        draw_rectangle_color(205, 242, 275, 248, 0x1A1A1A, 0x1A1A1A, 0x1A1A1A, 0x1A1A1A, 0)
        draw_rectangle_color(205, 250, 275, 256, 0x1A1A1A, 0x1A1A1A, 0x1A1A1A, 0x1A1A1A, 0)
        draw_rectangle_color(277, 250, 302, 256, 0x1A1A1A, 0x1A1A1A, 0x1A1A1A, 0x1A1A1A, 0)
        draw_set_color(c_white)
        draw_text(240, 240, "Price / kg")
        draw_set_color(c_white)
        draw_text(240, 248, "Price / slot")
        draw_set_color(c_white)
        draw_text(290, 248, "(Max)")
        var _name = loot_name
        if (obj_player.trading == 1)
